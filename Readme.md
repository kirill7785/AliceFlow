...
1. Отвалилась гидродинамика на адаптивных локально измельчённых сетках. 03.01.2023.
2. Если включить асемблес в модели BSK_Dmitrii_modify.txt то решение нефично низкую температуру показывает в этом асемблесе. 03.01.2023.
