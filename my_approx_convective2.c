...
doublereal UNEVEN_ISNAS_SCHEME(doublereal f_C, doublereal xQ, doublereal yQ) {
	...
	*/
	...
	// Данная схема не прошлапроверку в maple. График получается лежащим вне области
	// удовлетворяющей критерию конвективной ограниченности. В интернете оригинал данной схемы найти не удалось.
