			...
			*/
			...
			if (bextendedprint) {
				for (i = 0; i < maxbound; i++) {
					...
					case E: fprintf(fp, "%+.16f ", pa[nvtx[0][sosedb[i].iI] - 1].x);
						break;
					case W: fprintf(fp, "%+.16f ", pa[nvtx[1][sosedb[i].iI] - 1].x);
						break;
					case N: fprintf(fp, "%+.16f ", 0.5*(pa[nvtx[0][sosedb[i].iI] - 1].x + pa[nvtx[1][sosedb[i].iI] - 1].x));
						break;
					case S: fprintf(fp, "%+.16f ", 0.5*(pa[nvtx[0][sosedb[i].iI] - 1].x + pa[nvtx[1][sosedb[i].iI] - 1].x));
						break;
					case T: fprintf(fp, "%+.16f ", 0.5*(pa[nvtx[0][sosedb[i].iI] - 1].x + pa[nvtx[1][sosedb[i].iI] - 1].x));
						break;
					case B: fprintf(fp, "%+.16f ", 0.5*(pa[nvtx[0][sosedb[i].iI] - 1].x + pa[nvtx[1][sosedb[i].iI] - 1].x));
						break;
					}
					if (i % 10 == 0) fprintf(fp, "\n");
				}
			...
			if (bextendedprint) {
				for (i = 0; i < maxbound; i++) {
					switch (sosedb[i].Norm) {// определим внутреннюю нормаль к границе
					case E: fprintf(fp, "%+.16f ", 0.5*(pa[nvtx[0][sosedb[i].iI] - 1].y + pa[nvtx[2][sosedb[i].iI] - 1].y));
						break;
					case W: fprintf(fp, "%+.16f ", 0.5*(pa[nvtx[0][sosedb[i].iI] - 1].y + pa[nvtx[2][sosedb[i].iI] - 1].y));
						break;
					case N: fprintf(fp, "%+.16f ", pa[nvtx[0][sosedb[i].iI] - 1].y);
						break;
					case S: fprintf(fp, "%+.16f ", pa[nvtx[2][sosedb[i].iI] - 1].y);
						break;
					case T: fprintf(fp, "%+.16f ", 0.5*(pa[nvtx[0][sosedb[i].iI] - 1].y + pa[nvtx[2][sosedb[i].iI] - 1].y));
						break;
					case B: fprintf(fp, "%+.16f ", 0.5*(pa[nvtx[0][sosedb[i].iI] - 1].y + pa[nvtx[2][sosedb[i].iI] - 1].y));
						break;
					}
					if (i % 10 == 0) fprintf(fp, "\n");
				}
			...
			if (bextendedprint) {
				for (i = 0; i < maxbound; i++) {
					switch (sosedb[i].Norm) {// определим внутреннюю нормаль к границе
					case E: fprintf(fp, "%+.16f ", 0.5*(pa[nvtx[0][sosedb[i].iI] - 1].z + pa[nvtx[4][sosedb[i].iI] - 1].z));
						break;
					case W: fprintf(fp, "%+.16f ", 0.5*(pa[nvtx[0][sosedb[i].iI] - 1].z + pa[nvtx[4][sosedb[i].iI] - 1].z));
						break;
					case N: fprintf(fp, "%+.16f ", 0.5*(pa[nvtx[0][sosedb[i].iI] - 1].z + pa[nvtx[4][sosedb[i].iI] - 1].z));
						break;
					case S: fprintf(fp, "%+.16f ", 0.5*(pa[nvtx[0][sosedb[i].iI] - 1].z + pa[nvtx[4][sosedb[i].iI] - 1].z));
						break;
					case T: fprintf(fp, "%+.16f ", pa[nvtx[0][sosedb[i].iI] - 1].z);
						break;
					case B: fprintf(fp, "%+.16f ", pa[nvtx[4][sosedb[i].iI] - 1].z);
						break;
					}
					if (i % 10 == 0) fprintf(fp, "\n");
				}
