	...
	integer& iunion_id_p1)
{
	...
	// Алгоритм. 27.06.2021.
	// A. Разбить всю область на непересекающиеся тела достаточно произвольной формы каждое.
	...
	// 2. В простом случае просто прямая прямоугольная шестигранная призма.
	// 3. Цилиндр.
	...
	// преобразование b и lb в список простых примитивов.
	//  Код буду писать по русски словами:
	// 1. Пусть у нас есть только скошенные восьмиугольные призмы в 3D они не пересекаются.
	// Тогда бьём сеткой отдельно каждую призму и стыкуемся по границам - граням призм.
	// 2. Если у нас внутренний цилиндр обособленный ни с кем не пересекающийся то мы помещаем его во внешний
	// прямоугольный контейнер который тоже ни с кем не пересекется и добавляем этот контейнер к списку кубиков из спска п. 1.
	// для появления кубиков соседей с этим контейнером. Внутренность этого кубика с цилиндром мы разбиваем
	// с учетом того что внутри него один цилиндр.
