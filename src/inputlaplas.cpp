...
typedef struct TMY_AMG_MANAGER {
	...
	// spai-0 smoother
	bool b_spai0Temp = false, b_spai0Speed = false, b_spai0Pressure = false, b_spai0Stress = false;
	bool b_spai0 = false;
...
typedef struct TFLOWINFO {
	...
	integer bfdelta=0, bSmagorinskyLilly=0, bsurface_roughness=0;
