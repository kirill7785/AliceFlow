// ƒвунаправленный линейный список.
// »спользуютс€ в алгебраическом многосеточном методе.
#pragma once
#ifndef _BIDIRECTIONAL_LINEAR_LIST_CPP_
#define _BIDIRECTIONAL_LINEAR_LIST_CPP_ 1

// ƒвунаправленный линейный список целочисленных элементов. 
// ћожет сканироватьс€ как вперЄд так и назад.
...
void insertion_list_i(hashlist_i*& p, integer d) {
  ...
  // очистка списка
  // ¬еро€тно содержит ошибку потому что пам€ть не освобождаетс€.
  // TODO 17 dec 2015
  // ѕроверено 1 €нвар€ 2017.
