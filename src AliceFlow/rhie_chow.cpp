...
doublereal rFgRhieChow_internal_border1(integer iP, integer G, doublereal rhog, doublereal alpha, 
	...
	//system("pause"); // debug граничные условия для давления

	//doublereal  PP, PG;

	//doublereal PbackG = 0.0;
	doublereal PbackG=pressure[ibackG];
	doublereal PP=pressure[iP];
	doublereal PG=pressure[iG];
...
doublereal ugRhieChow_internal_border(integer iP, integer G, doublereal alpha, 
	...
	//doublereal PbackGG=0.0;
	doublereal PbackGG=pressure[ibackGG]; // значение давления в этом узле.
