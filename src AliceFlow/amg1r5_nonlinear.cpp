...
L9:
	...
	u_old = (doublereal*)malloc((static_cast<integer>(n_a)+1) * sizeof(doublereal));

	doublereal* rthdsd_no_radiosity_patch_1 = nullptr;
	rthdsd_no_radiosity_patch_1 = (doublereal*)malloc((static_cast<integer>(n_a)+1) * sizeof(doublereal));
	...
	//x_temper = new doublerealT[n_a[0] + 1];
	x_temper = (doublereal*)malloc((static_cast<integer>(n_a)+1) * sizeof(doublereal));
	...
	rthdsd_loc123 = (doublereal*)malloc((static_cast<integer>(n_a)+1) * sizeof(doublereal));
	...
	while (/*(*res>0.1306)||(fabs(tmax- tmaxold)>2.0e-5)||*/(rms1/rms<15.0)&&(iter<300)) {
		...
		std::cout << iter << " tmax=" << tmax << " rms=" << rms << " rms1/rms=" << rms1 / rms << "\n";
