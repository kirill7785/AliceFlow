...
void qs(Ak2& Amat, integer first, integer last) {
	...
	if (last - first < INSERTION_SIZE) {
		...
		*/
		...
		if (1) {
			if (last - first < 3000) {
				pivot = Amat.i[static_cast<integer>((first + last) / 2)];
			}
			else if (last - first < 800000) {
				pivot = static_cast<integer>((Amat.i[first + 100] + Amat.i[(first + last) / 2] + Amat.i[last - 100]) / 3.0);
			}
			else {
				pivot = 0;
				pivot = static_cast<integer>((Amat.i[first] + Amat.i[first + 100000] + Amat.i[first + 200000] + Amat.i[first + 300000] + Amat.i[first + 400000] + Amat.i[first + 500000] + Amat.i[first + 600000] + Amat.i[first + 700000] + Amat.i[last]) / 9.0);
			}
...
void qsj(Ak2& Amat, integer first, integer last) {
	...
	if (last - first < INSERTION_SIZE) {
		...
		*/
		...
		if (1) {
			if (last - first < 3000) {
				pivot = Amat.j[static_cast<integer>((first + last) / 2)];
			}
			else if (last - first < 800000) {
				pivot = static_cast<integer>((Amat.j[first + 100] + Amat.j[(first + last) / 2] + Amat.j[last - 100]) / 3.0);
			}
			else {
				pivot = 0;
				pivot = static_cast<integer>((Amat.j[first] + Amat.j[first + 100000] + Amat.j[first + 200000] + Amat.j[first + 300000] + Amat.j[first + 400000] + Amat.j[first + 500000] + Amat.j[first + 600000] + Amat.j[first + 700000] + Amat.j[last]) / 9.0);
			}
