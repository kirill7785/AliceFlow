// Возможно ли вообще не добавлять С узлы ? 
// Future TODO: 19-20.10.2021 FFFFFC версия. Шесть F узлов подряд.
// CFFFFFFC
// Думается применить к PMIS аггрегатору на квадрате матрицы А (соседи соседей).
...
#pragma omp parallel for reduction(+: iadditionalCstatistic, iadds0, iOPORNAQ_C0, iOPORNAQ_C1, iOPORNAQ_C2, iOPORNAQ_C3, iOPORNAQ_C4, iOPORNAQ_C5)
		for (integer i8 = 1; i8 <= n_a[ilevel - 1]; ++i8) if (this_is_F_node[i8]) {
			...
			if (iend_for1 != ii1) {
					...
					if (Amat.j[is0] != istr_etalon1) {
						if (this_is_C_node[Amat.j[is0]]) {
							...
							if (fabs(Amat.aij[is0]) > maxelem_threshold_theta) {
								sumPC += fabs(Amat.aij[is0]); // сумма модулей внедиагональных элементов которые принадлежат Strongly С узлам.	
								iOPORNAQ_C++;
								iOPORNAQ_C0++;
								iOPORNAQ_C0_1++;
							}
							...
							if (this_is_F_node[Amat.j[is0]]) {
								...
								if (fabs(Amat.aij[is0]) > maxelem_threshold_theta_strong_F) {
									...
									sumPF += fabs(Amat.aij[is0]); // сумма модулей внедиагональных элементов которые принадлежат Strongly F узлам.
								}
							}
						}
					}
							...
							if (this_is_C_node[Amat.j[is0]]) {
								...
								if (this_is_F_node[Amat.j[is0]]) {
									...
									if (fabs(Amat.aij[is0]) > maxelem_threshold_theta_strong_F) {
										...
										// Новое порождение всего для узла i8_1.
										...
										// Здесь maxelem_threshold_1 это модуль максимального внедиагонального элемента в строке среди С соседей.
											...
											if ((Amat.j[is0_1] != istr_etalon1) && (Amat.j[is0_1] != istr_etalon1_1)) {
												if (this_is_C_node[Amat.j[is0_1]]) {
													...
													if (fabs(Amat.aij[is0_1]) > maxelem_threshold_theta_1) {
														sumPC_1 += fabs(Amat.aij[is0_1]); // сумма модулей внедиагональных элементов которые принадлежат Strongly С узлам.	
														iOPORNAQ_C++;
														iOPORNAQ_C1++;
														iOPORNAQ_C1_1++;
														i_na_odnoi_vetke_C2++;
													...
													if (this_is_F_node[Amat.j[is0_1]]) {
														...
														if (fabs(Amat.aij[is0_1]) > maxelem_threshold_theta_strong_F_1) {
															...
															sumPF_1 += fabs(Amat.aij[is0_1]); // сумма модулей внедиагональных элементов которые принадлежат Strongly F узлам.
														}
													}
												}
											}
													...
													if (this_is_C_node[Amat.j[is0_1]]) {
														...
														if (this_is_F_node[Amat.j[is0_1]]) {
															...
															if (fabs(Amat.aij[is0_1]) > maxelem_threshold_theta_strong_F_1) {
																...
																// Новое порождение всего для узла i8_2.
																...
																// Здесь maxelem_threshold_2 это модуль максимального внедиагонального элемента в строке среди С соседей.
																	...
																	if ((Amat.j[is0_2] != istr_etalon1) && (Amat.j[is0_2] != istr_etalon1_1) && (Amat.j[is0_2] != istr_etalon1_2)) {
																		if (this_is_C_node[Amat.j[is0_2]]) {
																			...
																			if (fabs(Amat.aij[is0_2]) > maxelem_threshold_theta_2) {
																				sumPC_2 += fabs(Amat.aij[is0_2]); // сумма модулей внедиагональных элементов которые принадлежат Strongly С узлам.
																				iOPORNAQ_C++;
																				iOPORNAQ_C2++;
																				iOPORNAQ_C2_1++;
																				i_na_odnoi_vetke_C2++;
																			...
																			if (this_is_F_node[Amat.j[is0_2]]) {
																				...
																				if (fabs(Amat.aij[is0_2]) > maxelem_threshold_theta_strong_F_2) {
																					...
																					sumPF_2 += fabs(Amat.aij[is0_2]); // сумма модулей внедиагональных элементов которые принадлежат Strongly F узлам.
																				}
																			}
																		}
																	}
																			...
																			if (this_is_C_node[Amat.j[is0_2]]) {
																				...
																				if (this_is_F_node[Amat.j[is0_2]]) {
																					...
																					if (fabs(Amat.aij[is0_2]) > maxelem_threshold_theta_strong_F_2) {
																						...
																						///******************************************************************
																						// Новое порождение всего для узла i8_3.
										                                               ...
										                                               //********************************************************
																						...
																						// Здесь maxelem_threshold_3 это модуль максимального внедиагонального элемента в строке среди С соседей.
																							...
																							if ((Amat.j[is0_3] != istr_etalon1) && (Amat.j[is0_3] != istr_etalon1_1) && (Amat.j[is0_3] != istr_etalon1_2) && (Amat.j[is0_3] != istr_etalon1_3)) {
																								if (this_is_C_node[Amat.j[is0_3]]) {
																									...
																									if (fabs(Amat.aij[is0_3]) > maxelem_threshold_theta_3) {
																										sumPC_3 += fabs(Amat.aij[is0_3]); // сумма модулей внедиагональных элементов которые принадлежат Strongly С узлам.	
																										iOPORNAQ_C++;
																										iOPORNAQ_C3++;
																										iOPORNAQ_C3_1++;
																										i_na_odnoi_vetke_C2++;
																									...
																									if (this_is_F_node[Amat.j[is0_3]]) {
																										...
																										if (fabs(Amat.aij[is0_3]) > maxelem_threshold_theta_strong_F_3) {
																											...
																											sumPF_3 += fabs(Amat.aij[is0_3]); // сумма модулей внедиагональных элементов которые принадлежат Strongly F узлам.
																										}
																									}
																								}
																							}
																									...
																									if (this_is_C_node[Amat.j[is0_3]]) {
																										...
																										if (this_is_F_node[Amat.j[is0_3]]) {
																											...
																											if (fabs(Amat.aij[is0_3]) > maxelem_threshold_theta_strong_F_3) {
																												...
																												// Новое порождение всего для узла i8_4.
																												...
																												// Здесь maxelem_threshold_4 это модуль максимального внедиагонального элемента в строке среди С соседей.
																													...
																													if ((Amat.j[is0_4] != istr_etalon1) && (Amat.j[is0_4] != istr_etalon1_4)) {
																														if (this_is_C_node[Amat.j[is0_4]]) {
																															...
																															if (fabs(Amat.aij[is0_4]) > maxelem_threshold_theta_4) {
																																sumPC_4 += fabs(Amat.aij[is0_4]); // сумма модулей внедиагональных элементов которые принадлежат Strongly С узлам.	
																																iOPORNAQ_C++;
																																iOPORNAQ_C4++;
																																iOPORNAQ_C4_1++;
																																i_na_odnoi_vetke_C2++;
																															...
																															if (this_is_F_node[Amat.j[is0_4]]) {
																																...
																																if (fabs(Amat.aij[is0_4]) > maxelem_threshold_theta_strong_F_4) {
																																	...
																																	sumPF_4 += fabs(Amat.aij[is0_4]); // сумма модулей внедиагональных элементов которые принадлежат Strongly F узлам.
																																}
																															}
																														}
																													}
																															...
																															if (this_is_C_node[Amat.j[is0_4]]) {
																																...
																																if (this_is_F_node[Amat.j[is0_4]]) {
																																	...
																																	if (fabs(Amat.aij[is0_4]) > maxelem_threshold_theta_strong_F_4) {
																																		...
																																		// Новое порождение всего для узла i8_5.
																																	...
																																	// Здесь maxelem_threshold_5 это модуль максимального внедиагонального элемента в строке среди С соседей.
																																		...
																																		if ((Amat.j[is0_5] != istr_etalon1) && (Amat.j[is0_5] != istr_etalon1_1) && (Amat.j[is0_5] != istr_etalon1_2) && (Amat.j[is0_5] != istr_etalon1_3) && (Amat.j[is0_5] != istr_etalon1_4) && (Amat.j[is0_5] != istr_etalon1_5)) {
																																			if (this_is_C_node[Amat.j[is0_5]]) {
																																				...
																																				if (fabs(Amat.aij[is0_5]) > maxelem_threshold_theta_5) {
																																					sumPC_5 += fabs(Amat.aij[is0_5]); // сумма модулей внедиагональных элементов которые принадлежат Strongly С узлам.	
																																					iOPORNAQ_C++;
																																					iOPORNAQ_C5++;
																																					iOPORNAQ_C5_1++;
																																					i_na_odnoi_vetke_C2++;
																																...
																																// Окончание нового порождения i8_5.
																																//********************************************************
																												...
																												// Окончание нового порождения i8_4.
																												//********************************************************
																					...
																					// Окончание нового порождения i8_3.
																...
																// Окончание нового порождения i8_2.
										...
										//********************************************************
										// Окончание нового порождения i8_1.
				...
				// без этого улучшения качества сетки итераций слишком много.
				// Обязательно нужно улучшить сетку в соответствии с этими критериями.
				if ((iOPORNAQ_C == 0) ||
				...
				// Либо нет С узлов вообще, Либо есть только один С узхел, но он достаточно далеко на расстоянии 2 и выше.
				// Либо есть только два узла только на одной ветке и только дальние.
			}

			if (ii1 == (row_startA[istr_etalon1 + 1] - 1)) bproblem = false; // Условие Дирихле мы не добавляем в С узлы. 01.10.2021
			if (ii1 + 1 == (row_startA[istr_etalon1 + 1] - 1)) bproblem = false; // однородное условие Неймана 01.10.2021
			//if (ii1 + 2 <= (row_startA[istr_etalon1 + 1] - 1)) {
				// Один узел два соседа
				//if (iOPORNAQ_C == 0) {
					//и среди соседей нету сильного С узла.
				//    bproblem = false;
				//}
		//	}
...
// пять F узлов подряд.
// 25.09.2021 FFFFC версия
// CFFFFFC
// Достаточно неплохо себя проявила для PMIS2 (PMIS примененного к квадрату матрицы) на всех уровнях вложенной сетки.
template <typename doublerealT>
...
// четыре F узла подряд.
// 25.09.2021 FFFC версия
// 03.10.2021 ok
// CFFFFC
// Недостаточна в качестве long range interpolation.
// В качестве long range interpolation значительно лучше себя проявляет версия  CFFFFFC.
template <typename doublerealT>
...
#pragma omp critical
	...
	*/
	...
	if (1 && (!byes_add)) {
		...
		bool** permission_to_use_F = new bool* [8];// Разрешение на использование F.
