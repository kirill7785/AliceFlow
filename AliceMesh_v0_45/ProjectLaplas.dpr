...
uses
  ...
  UnitSearchElementinTree in 'UnitSearchElementinTree.pas' {FormSearchElement_in_Tree},
  UnitAdaptRegionALICEMesh in 'UnitAdaptRegionALICEMesh.pas' {FormAdaptRedionALICEMesh},
  UnitExportAliceFlow2D in 'UnitExportAliceFlow2D.pas' {FormExportAliceFlow2D},
  UnitObjfromSpaceClaim in 'UnitObjfromSpaceClaim.pas' {FormObjfromSpaceClaim},
  UnitSetHpolyinReadOBJFiles in 'UnitSetHpolyinReadOBJFiles.pas' {FormHpolyinOBJFiles},
  UnitCSVExcel_Export in 'UnitCSVExcel_Export.pas' {FormCSV_Excel_export},
  UnitMinimumgapMeshGenerator in 'UnitMinimumgapMeshGenerator.pas' {FormMinimum_gap},
  UnitMoveSTL_position in 'UnitMoveSTL_position.pas' {FormMoveSTLposition},
  UnitOrientation_pcb_plate_in_space in 'UnitOrientation_pcb_plate_in_space.pas' {FormOrientation_pcb_plate},
  UnitNetwork in 'UnitNetwork.pas' {FormNetwork};
...
begin
  ...
  Application.CreateForm(TFormSearchElement_in_Tree, FormSearchElement_in_Tree);
  Application.CreateForm(TFormAdaptRedionALICEMesh, FormAdaptRedionALICEMesh);
  Application.CreateForm(TFormExportAliceFlow2D, FormExportAliceFlow2D);
  Application.CreateForm(TFormObjfromSpaceClaim, FormObjfromSpaceClaim);
  Application.CreateForm(TFormHpolyinOBJFiles, FormHpolyinOBJFiles);
  Application.CreateForm(TFormCSV_Excel_export, FormCSV_Excel_export);
  Application.CreateForm(TFormMinimum_gap, FormMinimum_gap);
  Application.CreateForm(TFormMoveSTLposition, FormMoveSTLposition);
  Application.CreateForm(TFormOrientation_pcb_plate, FormOrientation_pcb_plate);
