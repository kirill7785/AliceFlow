...
* Схемы высокой разрешающей способности для аппроксимации конвекции на структурированной сетке: WACEB, SMARTER, SUPER-C и др. (А также для АЛИС сетки Future jan 2021)
...
* Графический визуализатор на FWGL OpenGL на с++ встроенный в код программы. Визуализация результатов расчёта в 3D, анимация результатов нестационарного CFD расчёта. (Future jan 2021).
