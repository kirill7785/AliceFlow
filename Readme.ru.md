...
* 3D cfd Полунеявная процедура для связывающего  давление уравнения  (SIMPLE [1972]). Стационарный решатель.
...
* Дружелюбный графический интерфейс пользователя на  Delphi xe8.
